...
const CourseDetailPage = () => {
  ...
  const handleLessonPress = (lesson: Lesson, index: number) => {
    // Unlock logic removed – all lessons accessible
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Take Exam button enabled when all lessons completed */}
        <View style={{ paddingHorizontal: 20, paddingTop: 8 }}>
          <TouchableOpacity
            style={{
              backgroundColor: course.lessons.every((l) => l.isCompleted)
                ? "#8B5CF6"
                : "#E5E7EB",
              borderRadius: 12,
              paddingVertical: 12,
            ...
            disabled={!course.lessons.every((l) => l.isCompleted)}
            onPress={() => {
          ...
          >
            <Text
              style={{
                color: course.lessons.every((l) => l.isCompleted)
                  ? "#ffffff"
                  : "#9CA3AF",
                fontWeight: "800",
              }}
