...
// import ParentFooter from '../components/FooterNavigation';
                ...
                <View style={styles.optionsContainer}>
                  {question.options.map((option, optionIndex) => (
                    <View key={optionIndex} style={[
                      ...
                      question.studentAnswer === optionIndex && !question.isCorrect && styles.incorrectOption,
                    ]}>
                      <Text style={[
                        styles.optionText,
                        optionIndex === question.correctAnswer && styles.correctOptionText,
                        question.studentAnswer === optionIndex && !question.isCorrect && styles.incorrectOptionText,
                      ]}>
                        {option}
                      </Text>
                      ...
                      {question.studentAnswer === optionIndex && !question.isCorrect && (
